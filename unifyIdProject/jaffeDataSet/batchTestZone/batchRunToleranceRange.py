...
lowTolerance = sys.argv[1]
highTolerance = sys.argv[2]
...
for root,dirs,files in os.walk("all/"):
	for tol in range(lowTolerance*100,highTolerance*100+1):
		t = tol/100
	        for f in files:
                	enrolledImg = f
                	...
                	updateGlobalStats(globalStats,runRes)
                        #print("Tol: " + str(t) + " current global stats: " + str(globalStats))	
